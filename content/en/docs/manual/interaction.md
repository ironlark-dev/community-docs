...
weight: 36
description: >
  The use key, and why the host decides what was pressed rather than trusting the
  client that pressed it.
---
...
[what you cannot build yet](../not-yet/).

For area-based interaction that needs no key at all, use
[trigger volumes](../contact-events/) instead: walking into a zone is often the better verb.
