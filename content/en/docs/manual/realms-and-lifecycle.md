...
linkTitle: "Realms and lifecycle"
weight: 10
description: >
  A mod has up to two halves that run in different places with different powers,
  and both are loaded and torn down per session rather than per process.
---
