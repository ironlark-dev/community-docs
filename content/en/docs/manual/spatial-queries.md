...
linkTitle: "Spatial queries"
weight: 38
description: >
  Asking the world what is where — a ray, or a sphere. Read-only, and with one
  exclusion that shapes what you can build.
---
...
{{% alert title="Rays do not see player bodies" color="warning" %}}
