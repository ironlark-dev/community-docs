...
weight: 35
description: >
  How a mod learns that something touched one of its things — and how to make a
  zone players walk through rather than into.
---
...
{{% alert title="You must identify an instance to hear about it" color="warning" %}}
