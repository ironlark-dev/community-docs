...
weight: 32
description: >
  How a mod ships a thing that can exist in the world — a prop, a zone, a
  pressable pedestal — and what the manifest can say about it.
---
...
peer must have the addon — see [enabled content](../../guides/) and the join refusal in
...
- `interact = true` — a player pressing **use** while looking at it calls your
  `on-interact`. See [Interaction](../interaction/).
